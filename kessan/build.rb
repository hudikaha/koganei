  ...
  <body>
    ...
    <script>
      ...
      function renderChart(nodes,parent,depth){
        ...
        const appendDetails=()=>{
          const chosenSection=parent?.level===3?parent.children.find(node=>node.id===selected):null;if(chosenSection){section.append(businessBreakdown(parent,chosenSection));return}
